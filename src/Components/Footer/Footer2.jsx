...
const data = {
  newsletterText:
    " Stay updated with our latest <br /> tree service projects and tips.",
  menus: [
    {
      title: "SUPPORT",
      links: [
  ...
  copyright: "COLORES TREE SERVICE © 2025. ALL RIGHTS RESERVED.",
  bottomLinks: [
      ...
      <div className="container">
        <div className="cs_footer_row">
          <div className="cs_footer_col">
            <div className="cs_footer_widget cs_footer_contact_prominent">
              <a href="tel:+18313370454" className="cs_footer_phone">(831) 337-0454</a>
              <Link to="/contact" className="cs_footer_contact_link">Contact Us</Link>
            </div>
