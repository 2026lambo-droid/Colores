            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" to={data.logoUrl}>
                  <span className="cs_logo_text">COLORES TREE SERVICE</span>
                </Link>
              </div>
              ...
              <div className="cs_main_header_right">
                <a href="tel:+18313370454" className="cs_header_phone cs_heading_color">
                  (831) 337-0454
                </a>
                <Link to="/contact" className="cs_header_contact_btn cs_btn cs_style_1 cs_bold cs_heading_bg cs_white_color">
                  Contact Us
                </Link>
