        ...
        <div className="container">
          <div className="cs_hero_in">
            <div className="cs_hero_text">
              ...
              {data.intro ? (
                <div className="cs_hero_intro" data-aos="fade-up">
                  <p className="cs_hero_intro_lead">{data.intro.intro}</p>
                  <p className="cs_hero_intro_label">{data.intro.servicesHeading}</p>
                  <div className="cs_hero_intro_services">
                    {data.intro.services.map((name, index) => (
                      <span key={index} className="cs_hero_intro_service_item">{name}</span>
                    ))}
                  </div>
                  <p className="cs_hero_intro_closing">{data.intro.closing}</p>
                </div>
              ) : (
                <p
                  ...
                  <div style={{ marginTop: "20px", display: "flex", flexDirection: "column", gap: "8px" }}>
                    {data.funfact.trustIndicators.map((item, index) => (
                      ...
                      >
                        ...
                        />
                        <span className="cs_white_color" style={{ fontSize: "14px", lineHeight: "1.4" }}>
                          {item.text}
                        </span>
                      </div>
                    ))}
